module "cosmosdb_gremlin_database" {
  source = "git::https://github.com/Azure/azure-data-labs-modules.git//terraform/cosmosdb/cosmosdb-gremlin-database"
  ...
  private_dns_zone_ids = [data.azurerm_private_dns_zone.cosmos_gremlin.id]
...
data "azurerm_private_dns_zone" "cosmos_gremlin" {
  name                = local.dns_cosmos_gremlin
