variable "basename" {
  ...
  validation {
    ...
    error_message = "The name must be between 1 and 37 characters, can contain only lowercase letters, numbers and the '-' character, and must end with the character '-'."
  }
}
