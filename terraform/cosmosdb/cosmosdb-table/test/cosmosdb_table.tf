module "cosmosdb_table" {
  source = "git::https://github.com/Azure/azure-data-labs-modules.git//terraform/cosmosdb/cosmosdb-table"
  ...
  private_dns_zone_ids = [data.azurerm_private_dns_zone.cosmos_table.id]
