...
| <a name="input_throughput"></a> [throughput](#input\_throughput) | The throughput of Table (RU/s). | `number` | `400` | no |

## Outputs

| Name | Description |
|------|-------------|
| <a name="output_id"></a> [id](#output\_id) | Resource identifier of the instance of CosmosDB table. |
| <a name="output_name"></a> [name](#output\_name) | The name of the CosmosDB table. |
| <a name="output_resource_group_name"></a> [resource\_group\_name](#output\_resource\_group\_name) | Resource Group where the CosmosDB table exists. |
<!-- END_TF_DOCS -->